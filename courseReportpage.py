...
class CourseReportPage:
    def __init__(self,hwindow):
        ...
        self.window.title('Course Report page')
        ...
        self.headlbl = Label(self.window,text="Course Report ",font=("Georgia",35,"bold"),
        ...
        self.mytable.column('c1',width=240,anchor='center')
        self.mytable.column('c2',width=200,anchor='center')
        self.mytable.column('c3',width=200,anchor='center')
        self.mytable.column('c4',width=200,anchor='center')
        ...
        self.mytable.place(x=x1+x_diff,y=y1)
        self.b1.place(x=x1+x_diff+500,y=y1+500)
...
if __name__ == '__main__':
    dummyhomepage=Tk()
    CourseReportPage(dummyhomepage)
