...
class DepartmentReport:
    def __init__(self,hwindow):
        ...
        self.window.title('Department report ')
        ...
        self.headlbl = Label(self.window,text="Department Report ",font=("Georgia",35,"bold"),
        ...
        self.mytable.column('c1',width=250,anchor='center')
        self.mytable.column('c2',width=250,anchor='center')
        ...
        self.mytable.place(x=x1+x_diff+60+x_diff,y=y1)
        self.b1.place(x=x1+x_diff+400,y=y1+500)
    ...
    def getPrintout(self):
        pdf = my_cust_PDF()
        headings = ['Department Name', 'Head of Department']
...
if __name__ == '__main__':
    dummyhomepage=Tk()
    DepartmentReport(dummyhomepage)
